							...
							<table class="table table-hover" id='example'>
								...
								<?php foreach ($kelas as $key) { ?>
									<tr>
										...
										<td>
											<a href="<?php echo site_url('siswa/index/').$key->id ?>" type="button" class="btn btn-link">Siswa</a>
											<a href="<?php echo site_url('kelas/update/').$key->id ?>" type="button" class="btn btn-link">Edit</a>
											<a href="<?php echo site_url('kelas/delete/').$key->id ?>" type="button" class="btn btn-l
